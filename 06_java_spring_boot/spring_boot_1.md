...
![img](study_drive/06_java_spring_boot/imgs/intelli_complr_set.png)
![img](study_drive/06_java_spring_boot/imgs/intelli_adv_set.png)
...
![img](study_drive/06_java_spring_boot/imgs/spring_boot_cors_error.png)
...
Continua en [Buenas prácticas y protección de una API Rest](study_drive/06_java_spring_boot/spring_boot_2.md)
