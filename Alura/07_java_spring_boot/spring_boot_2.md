...
Continuación de [Desarrollo de una API Rest](study_drive/Alura/07_java_spring_boot/spring_boot_1.md) donde se vio:
...
Continua en
[Documentar, probar y preparar una API para su implementación](study_drive/Alura/07_java_spring_boot/spring_boot_3.md)
